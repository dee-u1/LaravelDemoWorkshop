...
@section('content')
    ...
    <form action="{{route('employees.store')}}" method="POST">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control @error('firstName') is-invalid @enderror" name="firstName" id="" value="{{old('firstName')}}" placeholder="">
                @error('firstName')
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control @error('lastName') is-invalid @enderror" name="lastName" id="" value="{{old('lastName')}}"  placeholder="">
                @error('lastName')
                    <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <input type="text" class="form-control @error('position') is-invalid @enderror" name="position" id="" value="{{old('position')}}"  placeholder="">
                @error('position')
                    <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
